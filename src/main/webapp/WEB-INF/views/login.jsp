...
<body>
	...
	<section class="vh-100">
		<div class="container-fluid h-custom">
			<div class="row d-flex justify-content-center align-items-center h-100">
				...
				<div class="col-md-9 col-lg-6 col-xl-5">
					<img src="./images/gosim.jpg" class="img-fluid" alt="Sample image">
				</div>
				...
				<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
					<form action="loginAf.do" method="post">
						...
						<div class="form-outline mb-3">
							<input type="password" id="form3Example4" name="pwd" class="form-control form-control-lg" placeholder="Enter password" /> <label class="form-label" for="form3Example4">Password</label>
						</div>
		...
		<div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">
			<!-- Copyright -->
			<div class="text-white mb-3 mb-md-0">Copyright © 일러스트 최고심</div>
			<!-- Copyright -->
